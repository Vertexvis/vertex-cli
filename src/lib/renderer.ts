...
<html lang="">
  <head>
   ...
   <link
    ...
    <script
      nomodule
      src="https://unpkg.com/@vertexvis/viewer@0.15.0/dist/viewer.js"
    ></script>
    <style>
      html,
      body,
  ...
  <body>
    ...
    <script type="module">
      import { applyPolyfills, defineCustomElements } from 'https://unpkg.com/@vertexvis/viewer@0.15.0/loader/index.js';
