...
@vertexvis/vertex-cli/0.3.7 darwin-x64 node-v14.15.4
$ vertex --help [COMMAND]
USAGE
  $ vertex COMMAND
...
...
_See code: [src/commands/create-items.ts](https://github.com/Vertexvis/vertex-cli/blob/v0.3.7/src/commands/create-items.ts)_
...
_See code: [src/commands/create-parts.ts](https://github.com/Vertexvis/vertex-cli/blob/v0.3.7/src/commands/create-parts.ts)_
...
_See code: [src/commands/create-scene.ts](https://github.com/Vertexvis/vertex-cli/blob/v0.3.7/src/commands/create-scene.ts)_
...
_See code: [src/commands/create-stream-key.ts](https://github.com/Vertexvis/vertex-cli/blob/v0.3.7/src/commands/create-stream-key.ts)_
...
_See code: [src/commands/delete.ts](https://github.com/Vertexvis/vertex-cli/blob/v0.3.7/src/commands/delete.ts)_
...
_See code: [src/commands/render-image.ts](https://github.com/Vertexvis/vertex-cli/blob/v0.3.7/src/commands/render-image.ts)_
<!-- commandsstop -->
